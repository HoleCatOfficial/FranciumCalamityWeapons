...
{
	public class Conquistador : ModItem
	{
		public override void SetDefaults() {
			// Modders can use Item.DefaultToRangedWeapon to quickly set many common properties, such as: useTime, useAnimation, useStyle, autoReuse, DamageType, shoot, shootSpeed, useAmmo, and noMelee. These are all shown individually here for teaching purposes.

			// Common Properties
			Item.width = 72; // Hitbox width of the item.
			Item.height = 110; // Hitbox height of the item.
			...
			Item.UseSound = new SoundStyle($"FranciumCalamityWeapons/Audio/ExobladeBeamSlash") {
				Volume = 0.9f,
				PitchVariance = 0.8f,
				MaxInstances = 3,
			};
			...
			Item.damage = 4000; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
