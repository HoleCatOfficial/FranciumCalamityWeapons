...
{
	public class LuminousPartisan : ModItem
	{
        ...
        SoundStyle Stab = new SoundStyle("FranciumCalamityWeapons/Audio/LuminousPartisanStab");
		...
		public override void SetDefaults()
        {
            ...
            Item.UseSound = Stab; // The sound that this item plays when used.
            ...
            Item.shootSpeed = 5.7f; // The speed of the projectile measured in pixels per frame.
            Item.shoot = ModContent.ProjectileType<LuminousPartisanStab>(); // The projectile that is fired from this weapon
        }
