...
namespace FranciumCalamityWeapons.Content.Melee.Legacy
{
	...
	public class Overlord_Legacy : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.damage = 3600; // The damage of your sword, this is dynamically adjusted in the projectile code.
			Item.DamageType = DamageClass.Melee; // Deals melee damage
			Item.noMelee = true;  // This makes sure the item does not deal damage from the swinging animation
			Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand

			// Projectile Properties
			Item.shoot = ModContent.ProjectileType<OverlordSwing_Legacy>(); // The sword as a projectile
		}
