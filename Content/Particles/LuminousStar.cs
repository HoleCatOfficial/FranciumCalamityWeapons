...
namespace FranciumCalamityWeapons.Content.Particles
{
    ...
    internal class LuminousStar : BasePRT
    {
        ...
        public override void AI()
        {
            ...
            Color LumenylLight = new Color(117, 249, 249);
            Color LumenylDark = new Color(47, 26, 75);

            Color = Color.Lerp(LumenylLight, LumenylDark, Lifetime);
