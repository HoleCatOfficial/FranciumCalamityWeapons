...
namespace FranciumCalamityWeapons.Content.Particles
{
    ...
    internal class CosmicWrathStarParticle : BasePRT
    {
        ...
        public override void SetProperty()
        {
            ...
            //Rotation = Main.rand.NextFloat(0, MathHelper.TwoPi); // Random rotation angle.
            Scale = Main.rand.NextFloat(0.5f, 1.5f); // Random scale between 0.5 and 1.5.
            Origin = new Vector2(TexValue.Width / 2f, TexValue.Height / 2f);
        }
        ...
        public override void AI()
        {
            ...
            PRTLoader.NewParticle(PRTLoader.GetParticleID<GlowParticleNoGrav>(), Origin, Vector2.Zero, CalCTAUtils.GodSlayerInfernoGradient((float)(0.5 * (1 + Math.Sin(Main.GlobalTimeWrappedHourly * 2f * Math.PI)))), 1.6f);
