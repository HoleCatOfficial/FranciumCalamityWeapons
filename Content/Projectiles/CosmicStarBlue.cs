...
namespace FranciumCalamityWeapons.Content.Projectiles
{
	...
	public class CosmicStarBlue : ModProjectile
	{
		...
		{
			Lighting.AddLight(Projectile.Center, CosmicBlue.ToVector3() * 1.0f);
			...
			PRTLoader.NewParticle(type[Main.rand.Next(type.Length)], Projectile.Center, Vector2.Zero, CosmicBlue * 0.4f, 0.1f);
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
			...
			PRTLoader.NewParticle(PRTLoader.GetParticleID<Boom3>(), Projectile.Center, Vector2.Zero, CosmicBlue, 1);
			PRTLoader.NewParticle(PRTLoader.GetParticleID<BloomRingSharp>(), Projectile.Center, Vector2.Zero, CosmicBlue, 1);
		}
	}
}