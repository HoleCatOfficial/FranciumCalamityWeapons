...
{
	public class TheCrystalHoldout : ModProjectile
	{
		public override string Texture => "FranciumCalamityWeapons/Content/Projectiles/EyeofNirvanaHoldout";
		...
		private void FireBeams() {
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, beamVelocity, ModContent.ProjectileType<TheCrystalBeam>(), damage, knockback, Projectile.owner, b, uuid);
			}
