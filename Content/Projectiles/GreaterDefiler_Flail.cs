...
namespace FranciumCalamityWeapons.Content.Projectiles
{
	...
	public class GreaterDefiler_Flail : ModProjectile
	{
        public override string GlowTexture => "FranciumCalamityWeapons/Content/Projectiles/GreaterDefilerFlailGlowmask";
