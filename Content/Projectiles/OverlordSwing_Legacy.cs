...
namespace FranciumCalamityWeapons.Content.Projectiles
{
	...
	public class OverlordSwing_Legacy : ModProjectile
	{
		...
		public override string Texture => "FranciumCalamityWeapons/Content/Projectiles/OverlordSwing_Legacy"; // Use texture of item as projectile texture
		...
		public override void SetDefaults() {
			Projectile.width = 78; // Hitbox width of projectile
		...
		private void PrepareStrike() {
			...
			if (Timer >= prepTime) {
				SoundEngine.PlaySound(new SoundStyle("FranciumCalamityWeapons/Audio/Swing1"));  // Play sword sound here since playing it on spawn is too early
        ...
        private void ExecuteStrike() {
            ...
            if (CurrentAttack == AttackType.Spin) {
                ...
                if (Timer == (int)(execTime * SPINTIME * 3 / 4)) {
					SoundEngine.PlaySound(new SoundStyle("FranciumCalamityWeapons/Audio/Swing1")); // Play sword sound again
