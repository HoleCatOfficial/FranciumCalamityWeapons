...
namespace FranciumCalamityWeapons.Content.Resources;
	...
	public class FalseVacuum : ModItem
	{
        public override string Texture => "FranciumCalamityWeapons/Content/Resources/FalseVacuum";
        ...
        {
            gravity = 8f; // Disables gravity for this item
	...
	public override void AddRecipes() {
		if (ModLoader.TryGetMod("CalamityEntropy", out Mod CalamityEntropy))
		{
			if (CalamityEntropy.TryFind("VoidBar", out ModItem VB))
			{
				...
				.AddIngredient <Tenebris>(1)
				.AddIngredient(VB.Type, 1)
				.AddTile<CosmicAnvil>()
				.Register();
			}
		}
