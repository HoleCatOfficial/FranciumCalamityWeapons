    ...
    public class ExarchicEnforcerThrown : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            for (int i = 0; i < Main.rand.Next(3, 10); i++)
            {
                ...
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity * 2f, VoidStar1.Type, (int)(Projectile.damage * 0.25f), Projectile.knockBack, Projectile.owner);
            }
