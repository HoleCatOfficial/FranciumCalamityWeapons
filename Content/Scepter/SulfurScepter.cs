...
{
	public class SulfurScepter : ModItem
	{
        ...
        public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<SulfurScepterThrown>(); // The sword as a projectile
			Item.shootSpeed = 12f;
		...
		public override bool CanUseItem(Player player) {
            ...
            if (player.altFunctionUse == 2)
            {
                ...
                Item.shoot = ModContent.ProjectileType<SulfurScepterThrown>(); // The projectile is what makes a shortsword work
            ...
            else
            {
                ...
                Item.autoReuse = true; // This determines whether the weapon has autoswing
                Item.crit = 19; // The critical strike chance the weapon has. The player, by default, has a 4% critical strike chance.ion
                Item.shoot = ModContent.ProjectileType<SulfurScepterHoldout>(); // The sword as a projectile
		...
		public override void AddRecipes()
        {
            ...
            .AddIngredient<CorrodedFossil>(14)
